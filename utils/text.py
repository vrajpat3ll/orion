...
def _truncate_by_lines(
    ...
    """Truncate given text at line boundaries"""
    ...
    if not result_lines:
        # fallback to char truncation if no complete line can be truncated
...
def _truncate_by_chars(
    ...
    """Truncate given text by characters using binary search"""
    low, high = 0, len(text)
